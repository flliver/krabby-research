# This file was copied from parkour/scripts/rsl_rl/modules/actor_critic_with_encoder.py
...
class ActorCriticRMA(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        scan_encoder_dims = kwargs.pop('scan_encoder_dims')
        ...
        # Pass remaining kwargs (num_prop, num_scan, etc.) along with actor_cfg to Actor
