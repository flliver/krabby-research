# This file was copied from parkour/scripts/rsl_rl/modules/on_policy_runner_with_extractor.py
...
# See compute/parkour/policy_interface.py for context on why this copy was necessary.
...
class OnPolicyRunnerWithExtractor(OnPolicyRunner):
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        # Training-only: self.learn is only used for training loops
    ...
    # Training-only method: not used for inference
